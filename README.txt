...
There is two kinds of commands:
 ...
 - scriptim control commands: commands used to change the current card reader,
        exit, ...
...
command, last backslash removed.
    ...
    ex: FF 00 48\# beginning of the command
        00 00    # end of the command

        is equivalent to: FF 00 48 00 00
